...
%     for i=0:1:9
    for i = 0:1:9
        load(strcat('..//data//NGSIM//mat//speed_grid_', num2str(mr),'_', num2str(i),'.mat'))
...
%         tau = [50, 50];
        ...
        save(strcat('hat_mat','_', num2str(mr),'_',num2str(i),'.mat'),'mat_hat','rmse','rmse_total','mae','mae_total')
    end
end
